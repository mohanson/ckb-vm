(VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1661, (loc1));
      } else {
      dasm_put(Dst, 1667, Dt1(->registers[b.value.reg]));
      }
...
#line 1391 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1661, (b.value.x64_reg));
...
int aot_cond(AotContext* context, riscv_register_t target, AotValue condition, AotValue true_value, AotValue false_value) {
  ...
  switch (condition.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 499, (unsigned int)((uint64_t)1), (unsigned int)(((uint64_t)1)>>32));
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1708, (loc1));
        } else {
      dasm_put(Dst, 1714, Dt1(->registers[condition.value.reg]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(condition.value.reg);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1719, (loc1), (uint64_t)1);
        } else {
      dasm_put(Dst, 1727, Dt1(->registers[condition.value.reg]), (uint64_t)1);
        }
      }
...
#line 1453 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| jne >1
      dasm_put(Dst, 1740, (condition.value.x64_reg));
...
int aot_cpop(AotContext* context, riscv_register_t target, AotValue a)
{
  ...
  //| and rax, 0x7F
  //| op2_r_x mov, target, rax
  dasm_put(Dst, 1795, (unsigned int)(0x5555555555555555), (unsigned int)((0x5555555555555555)>>32), (unsigned int)(0x3333333333333333), (unsigned int)((0x3333333333333333)>>32), (unsigned int)(0x0F0F0F0F0F0F0F0F), (unsigned int)((0x0F0F0F0F0F0F0F0F)>>32));
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 711, (loc1));
  } else {
...
#line 1602 "src/machine/aot/aot.x64.c"
...
#line 1620 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      //| mov ecx, c.value.i
      dasm_put(Dst, 1160, c.value.i);
#line 1623 "src/machine/aot/aot.x64.c"
      break;
    case AOT_TAG_X64_REGISTER:
      //| mov rcx, Rq(c.value.x64_reg)
      dasm_put(Dst, 1149, (c.value.x64_reg));
#line 1626 "src/machine/aot/aot.x64.c"
      break;
  }
...
#line 1648 "src/machine/aot/aot.x64.c"
...
#line 1669 "src/machine/aot/aot.x64.c"
    return DASM_S_OK;
  }
...
#line 1689 "src/machine/aot/aot.x64.c"
      if (is_signed) {
        //| sar rax, cl
        dasm_put(Dst, 2028);
#line 1691 "src/machine/aot/aot.x64.c"
      } else {
        //| shr rax, cl
        dasm_put(Dst, 2033);
...
#line 1702 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| shl rax, cl
      //| mov ecx, edx
      dasm_put(Dst, 2053, (bits.value.x64_reg));
...
int aot_exit(AotContext* context, int code)
{
  ...
  //| mov rax, code
  //| jmp ->exit
  dasm_put(Dst, 2074, code);
#line 1730 "src/machine/aot/aot.x64.c"
  return DASM_S_OK;
}
...
int aot_mov_pc_internal(AotContext* context, AotValue value)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (ret != DASM_S_OK) { return ret; }
      //| mov machine->pc, rcx
      dasm_put(Dst, 1695, Dt1(->pc));
#line 1782 "src/machine/aot/aot.x64.c"
...
#line 1801 "src/machine/aot/aot.x64.c"
...
#line 1802 "src/machine/aot/aot.x64.c"
        ...
        case 0x40:
          ...
          dasm_put(Dst, 2103, Dt1(->pc), ((uint32_t)(value.value.i & 0x7FFFFFFF)), ((value.value.i >> 32) ^ 0x40000000));
...
#line 1809 "src/machine/aot/aot.x64.c"
          //| mov machine->pc, rcx
          dasm_put(Dst, 1695, Dt1(->pc));
#line 1810 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 2112, (value.value.x64_reg), Dt1(->pc));
...
#line 1836 "src/machine/aot/aot.x64.c"
      //| jne >1
      dasm_put(Dst, 855);
#line 1837 "src/machine/aot/aot.x64.c"
      ...
      //|1:
      dasm_put(Dst, 173);
#line 1840 "src/machine/aot/aot.x64.c"
...
#line 1850 "src/machine/aot/aot.x64.c"
      ...
      //|1:
      dasm_put(Dst, 173);
#line 1853 "src/machine/aot/aot.x64.c"
      ret = aot_mov_pc_internal(context, false_value);
      if (ret != DASM_S_OK) { return ret; }
      break;
  }
...
int aot_memory_write(AotContext* context, AotValue address, AotValue v, uint32_t size)
{
  ...
  dasm_put(Dst, 2120, size, Dt1(->memory));
#line 1874 "src/machine/aot/aot.x64.c"
...
#line 1879 "src/machine/aot/aot.x64.c"
    ...
    case 2:
      //| mov word [rdx+rax], cx
      dasm_put(Dst, 2145);
#line 1882 "src/machine/aot/aot.x64.c"
      break;
    case 4:
      //| mov dword [rdx+rax], ecx
      dasm_put(Dst, 2146);
#line 1885 "src/machine/aot/aot.x64.c"
      break;
    case 8:
      //| mov qword [rdx+rax], rcx
      dasm_put(Dst, 2150);
#line 1888 "src/machine/aot/aot.x64.c"
      break;
    default:
  ...
  //|2:
  dasm_put(Dst, 2155);
#line 1897 "src/machine/aot/aot.x64.c"
...
int aot_memory_read(AotContext* context, uint32_t target, AotValue address, uint32_t size)
{
  ...
  dasm_put(Dst, 2171, size, size, CKB_VM_ASM_RISCV_MAX_MEMORY);
#line 1918 "src/machine/aot/aot.x64.c"
  if (context->version >= 1) {
    //| ja >1
    dasm_put(Dst, 2204);
#line 1920 "src/machine/aot/aot.x64.c"
  } else {
    //| jae >1
    dasm_put(Dst, 2209);
#line 1922 "src/machine/aot/aot.x64.c"
  }
  //| lea rdx, machine->memory
  dasm_put(Dst, 2136, Dt1(->memory));
#line 1924 "src/machine/aot/aot.x64.c"
  switch (size) {
    case 1:
...
#line 1927 "src/machine/aot/aot.x64.c"
    ...
    case 2:
      ...
      dasm_put(Dst, 2219);
#line 1930 "src/machine/aot/aot.x64.c"
      break;
    case 4:
      //| mov ecx, dword [rdx+rax]
      dasm_put(Dst, 2224);
#line 1933 "src/machine/aot/aot.x64.c"
      break;
    case 8:
      //| mov rcx, qword [rdx+rax]
      dasm_put(Dst, 2228);
#line 1936 "src/machine/aot/aot.x64.c"
      break;
    default:
      return ERROR_INVALID_MEMORY_SIZE;
  }
...
#line 1941 "src/machine/aot/aot.x64.c"
  ...
  //| 1:
  dasm_put(Dst, 1733);
#line 1943 "src/machine/aot/aot.x64.c"
...
static int aot_mov_internal(AotContext* context, riscv_register_t target, AotValue value, x64_register_t x64_temp_reg)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 2233, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 2241, (loc1), Dt1(->registers[value.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 2112, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 2249, (x64_temp_reg), Dt1(->registers[value.value.reg]), (x64_temp_reg), Dt1(->registers[target]));
      }
#line 1959 "src/machine/aot/aot.x64.c"
      break;
    case AOT_TAG_IMMEDIATE:
      //| op2_r_imm mov, target, value.value.i, Rq(x64_temp_reg)
      if ((value.value.i >> (context->version >= 1? 31: 32)) > 0 && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
        loc1 = riscv_reg_to_x64_reg(target);
      dasm_put(Dst, 2264, (x64_temp_reg), (unsigned int)(value.value.i), (unsigned int)((value.value.i)>>32));
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 2233, (x64_temp_reg), (loc1));
        } else {
      dasm_put(Dst, 2112, (x64_temp_reg), Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
...
#line 1962 "src/machine/aot/aot.x64.c"
      break;
    case AOT_TAG_X64_REGISTER:
      //| op2_r_x mov, target, Rq(value.value.x64_reg)
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 2233, (value.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 2112, (value.value.x64_reg), Dt1(->registers[target]));
      }
#line 1965 "src/machine/aot/aot.x64.c"
      break;
  }
...
static int aot_mov_x64(AotContext* context, x64_register_t x64_target, AotValue value)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 2233, (loc1), (x64_target));
      } else {
      dasm_put(Dst, 2241, (x64_target), Dt1(->registers[value.value.reg]));
      }
#line 1978 "src/machine/aot/aot.x64.c"
      break;
    case AOT_TAG_IMMEDIATE:
      //| load_imm Rq(x64_target), value.value.i
      if ((value.value.i >> (context->version >= 1? 31: 32)) > 0 && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 2264, (x64_target), (unsigned int)(value.value.i), (unsigned int)((value.value.i)>>32));
      } else {
      dasm_put(Dst, 883, (x64_target), value.value.i);
      }
#line 1981 "src/machine/aot/aot.x64.c"
      break;
    case AOT_TAG_X64_REGISTER:
      if (x64_target == value.value.x64_reg) { return DASM_S_OK; }
      //| mov Rq(x64_target), Rq(value.value.x64_reg)
      dasm_put(Dst, 2233, (value.value.x64_reg), (x64_target));
#line 1985 "src/machine/aot/aot.x64.c"
      break;
  }
  return DASM_S_OK;
}
