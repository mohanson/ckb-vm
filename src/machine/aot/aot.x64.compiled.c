...
static const unsigned char bf_actions[1912] = {
  ...
  72,211,175,233,255,86,65,82,65,83,65,84,72,49,252,246,77,49,210,248,1,255,
  72,199,193,63,0,0,0,72,41,252,241,72,211,232,72,137,252,241,72,211,252,234,
  76,49,208,72,131,226,1,76,15,69,208,72,131,198,1,72,131,252,254,64,15,133,
  244,1,255,76,137,208,240,35,255,76,137,151,233,255,65,92,65,91,65,90,94,255,
  72,211,192,240,35,255,72,211,135,233,255,72,211,200,240,35,255,72,211,143,
  ...
  2,255,72,131,252,248,0,15,132,244,247,72,15,188,192,255,72,137,194,72,209,
  252,234,72,185,237,237,72,33,202,72,41,208,72,137,194,72,185,237,237,72,33,
  202,72,193,232,2,72,33,200,72,1,208,72,137,194,72,193,252,234,4,72,1,208,
  72,185,237,237,72,33,200,72,137,194,72,193,252,234,8,72,1,208,72,137,194,
  72,193,252,234,16,72,1,208,72,137,194,72,193,252,234,32,72,1,208,72,131,224,
  127,255,128,225,127,128,252,249,63,15,142,244,247,128,252,233,64,72,49,208,
  72,49,194,72,49,208,248,1,128,252,249,0,15,133,244,248,252,233,244,249,248,
  2,72,211,224,252,246,217,128,193,64,72,211,252,234,72,9,208,248,3,255,128,
  225,127,128,252,249,63,15,142,244,247,128,252,233,64,72,49,208,72,49,194,
  72,49,208,248,1,128,252,249,0,15,133,244,248,252,233,244,249,248,2,72,211,
  232,252,246,217,128,193,64,72,211,226,72,9,208,248,3,255,72,99,192,255,137,
  ...
  209,255,72,199,192,237,252,233,244,12,255,72,3,135,233,72,59,135,233,15,134,
  244,247,255,248,1,72,137,135,233,255,72,199,135,233,237,252,233,245,255,72,
...
int aot_clmulh(AotContext* context, riscv_register_t target, AotValue a, AotValue b) { return 0; }
...
#line 1109 "src/machine/aot/aot.x64.c"
  ...
  dasm_put(Dst, 1267, Dt1(->registers[target]));
  }
...
#line 1186 "src/machine/aot/aot.x64.c"
  ...
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 1291, (loc1));
  } else {
  dasm_put(Dst, 1297, Dt1(->registers[target]));
  }
...
int aot_eq(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1302, (loc1));
      } else {
      dasm_put(Dst, 1308, Dt1(->registers[b.value.reg]));
      }
...
#line 1266 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1302, (b.value.x64_reg));
...
int aot_cond(AotContext* context, riscv_register_t target, AotValue condition, AotValue true_value, AotValue false_value) {
  ...
  switch (condition.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 499, (unsigned int)((uint64_t)1), (unsigned int)(((uint64_t)1)>>32));
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1349, (loc1));
        } else {
      dasm_put(Dst, 1355, Dt1(->registers[condition.value.reg]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(condition.value.reg);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1360, (loc1), (uint64_t)1);
        } else {
      dasm_put(Dst, 1368, Dt1(->registers[condition.value.reg]), (uint64_t)1);
        }
      }
...
#line 1328 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| jne >1
      dasm_put(Dst, 1381, (condition.value.x64_reg));
...
int aot_cpop(AotContext* context, riscv_register_t target, AotValue a)
{
  ...
  //| and rax, 0x7F
  //| op2_r_x mov, target, rax
  dasm_put(Dst, 1436, (unsigned int)(0x5555555555555555), (unsigned int)((0x5555555555555555)>>32), (unsigned int)(0x3333333333333333), (unsigned int)((0x3333333333333333)>>32), (unsigned int)(0x0F0F0F0F0F0F0F0F), (unsigned int)((0x0F0F0F0F0F0F0F0F)>>32));
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 711, (loc1));
  } else {
...
#line 1544 "src/machine/aot/aot.x64.c"
  ...
  switch (bits.tag) {
    case AOT_TAG_REGISTER:
      ...
      //| mov ecx, edx
      dasm_put(Dst, 1653);
#line 1564 "src/machine/aot/aot.x64.c"
      if (is_signed) {
        //| sar rax, cl
        dasm_put(Dst, 1669);
...
#line 1577 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| shl rax, cl
      //| mov ecx, edx
      dasm_put(Dst, 1694, (bits.value.x64_reg));
...
#line 1589 "src/machine/aot/aot.x64.c"
        ...
        //| shr rax, cl
        dasm_put(Dst, 1674);
#line 1591 "src/machine/aot/aot.x64.c"
      }
      break;
  }
...
#line 1677 "src/machine/aot/aot.x64.c"
        ...
        case 0x40:
          ...
          dasm_put(Dst, 1744, Dt1(->pc), ((uint32_t)(value.value.i & 0x7FFFFFFF)), ((value.value.i >> 32) ^ 0x40000000));
...
#line 1685 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1753, (value.value.x64_reg), Dt1(->pc));
...
#line 1725 "src/machine/aot/aot.x64.c"
      ...
      //|1:
      dasm_put(Dst, 173);
#line 1728 "src/machine/aot/aot.x64.c"
      ret = aot_mov_pc_internal(context, false_value);
      if (ret != DASM_S_OK) { return ret; }
      break;
  }
...
int aot_memory_write(AotContext* context, AotValue address, AotValue v, uint32_t size)
{
  ...
  dasm_put(Dst, 1761, size, Dt1(->memory));
...
#line 1757 "src/machine/aot/aot.x64.c"
    ...
    case 4:
      ...
      dasm_put(Dst, 1787);
#line 1760 "src/machine/aot/aot.x64.c"
      break;
    case 8:
...
#line 1763 "src/machine/aot/aot.x64.c"
  ...
  //|2:
  dasm_put(Dst, 1796);
#line 1772 "src/machine/aot/aot.x64.c"
...
int aot_memory_read(AotContext* context, uint32_t target, AotValue address, uint32_t size)
{
  ...
  dasm_put(Dst, 1812, size, size, CKB_VM_ASM_RISCV_MAX_MEMORY);
#line 1793 "src/machine/aot/aot.x64.c"
  if (context->version >= 1) {
    //| ja >1
    dasm_put(Dst, 1845);
#line 1795 "src/machine/aot/aot.x64.c"
  } else {
    //| jae >1
    dasm_put(Dst, 1850);
#line 1797 "src/machine/aot/aot.x64.c"
  }
  //| lea rdx, machine->memory
  dasm_put(Dst, 1777, Dt1(->memory));
...
#line 1805 "src/machine/aot/aot.x64.c"
    ...
    case 4:
      ...
      dasm_put(Dst, 1865);
#line 1808 "src/machine/aot/aot.x64.c"
      break;
    case 8:
...
#line 1818 "src/machine/aot/aot.x64.c"
  ...
  //| 2:
  dasm_put(Dst, 830);
#line 1821 "src/machine/aot/aot.x64.c"
...
static int aot_mov_internal(AotContext* context, riscv_register_t target, AotValue value, x64_register_t x64_temp_reg)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1874, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1882, (loc1), Dt1(->registers[value.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 1753, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 1890, (x64_temp_reg), Dt1(->registers[value.value.reg]), (x64_temp_reg), Dt1(->registers[target]));
      }
#line 1834 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if ((value.value.i >> (context->version >= 1? 31: 32)) > 0 && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
        loc1 = riscv_reg_to_x64_reg(target);
      dasm_put(Dst, 1905, (x64_temp_reg), (unsigned int)(value.value.i), (unsigned int)((value.value.i)>>32));
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1874, (x64_temp_reg), (loc1));
        } else {
      dasm_put(Dst, 1753, (x64_temp_reg), Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
...
#line 1837 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1874, (value.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 1753, (value.value.x64_reg), Dt1(->registers[target]));
      }
...
static int aot_mov_x64(AotContext* context, x64_register_t x64_target, AotValue value)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1874, (loc1), (x64_target));
      } else {
      dasm_put(Dst, 1882, (x64_target), Dt1(->registers[value.value.reg]));
      }
#line 1853 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if ((value.value.i >> (context->version >= 1? 31: 32)) > 0 && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 1905, (x64_target), (unsigned int)(value.value.i), (unsigned int)((value.value.i)>>32));
      } else {
      dasm_put(Dst, 883, (x64_target), value.value.i);
      }
#line 1856 "src/machine/aot/aot.x64.c"
      break;
    case AOT_TAG_X64_REGISTER:
      if (x64_target == value.value.x64_reg) { return DASM_S_OK; }
      //| mov Rq(x64_target), Rq(value.value.x64_reg)
      dasm_put(Dst, 1874, (value.value.x64_reg), (x64_target));
#line 1860 "src/machine/aot/aot.x64.c"
      break;
  }
  return DASM_S_OK;
}
