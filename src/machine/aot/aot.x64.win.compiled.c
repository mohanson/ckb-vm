...
static const unsigned char bf_actions[2313] = {
  ...
  73,33,194,73,193,226,56,76,9,210,73,186,237,237,73,33,194,73,193,226,48,76,
  9,210,73,186,237,237,73,33,194,73,193,226,40,76,9,210,73,186,237,237,73,33,
  194,73,193,226,32,76,9,210,73,186,237,237,73,33,194,73,193,226,24,76,9,210,
  73,186,237,237,73,33,194,73,193,226,16,76,9,210,73,186,237,237,73,33,194,
  73,193,226,8,76,9,210,73,186,237,237,73,33,194,76,9,210,255,72,211,192,240,
  ...
  248,0,15,132,244,247,72,15,188,192,255,72,137,194,72,209,252,234,72,185,237,
  237,72,33,202,72,41,208,72,137,194,72,185,237,237,72,33,202,72,193,232,2,
  72,33,200,72,1,208,72,137,194,72,193,252,234,4,72,1,208,72,185,237,237,72,
  33,200,72,137,194,72,193,252,234,8,72,1,208,72,137,194,72,193,252,234,16,
  72,1,208,72,137,194,72,193,252,234,32,72,1,208,72,131,224,127,255,128,225,
  ...
  192,237,252,233,244,12,255,72,3,135,233,72,59,135,233,15,134,244,247,255,
  248,1,72,137,135,233,255,72,199,135,233,237,252,233,245,255,72,137,135,253,
  240,131,233,255,72,199,194,237,232,244,10,72,131,252,250,0,15,133,244,247,
  72,141,151,233,255,136,12,2,255,102,137,12,2,255,72,137,12,2,255,252,233,
  244,248,248,1,72,137,208,252,233,244,12,248,2,255,72,199,194,237,232,244,
  11,72,131,252,250,0,15,133,244,247,72,137,194,72,129,194,239,15,130,244,247,
  ...
  253,240,131,233,255,72,184,240,34,237,237,255
};
...
#line 1281 "src/machine/aot/aot.x64.c"
  ...
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 1681, (loc1));
  } else {
  dasm_put(Dst, 1687, Dt1(->registers[target]));
  }
...
#line 1311 "src/machine/aot/aot.x64.c"
  ...
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 1692, (loc1));
  } else {
  dasm_put(Dst, 1698, Dt1(->registers[target]));
  }
...
int aot_eq(AotContext* context, riscv_register_t target, AotValue a, AotValue b)
{
  ...
  switch (b.tag) {
    case AOT_TAG_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(b.value.reg);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1703, (loc1));
      } else {
      dasm_put(Dst, 1709, Dt1(->registers[b.value.reg]));
      }
...
#line 1391 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 1703, (b.value.x64_reg));
#line 1394 "src/machine/aot/aot.x64.c"
  ...
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 1731, (loc1));
  } else {
  dasm_put(Dst, 1737, Dt1(->registers[target]));
  }
...
int aot_cond(AotContext* context, riscv_register_t target, AotValue condition, AotValue true_value, AotValue false_value) {
  ...
  switch (condition.tag) {
    case AOT_TAG_REGISTER:
      ...
      dasm_put(Dst, 535, (unsigned int)((uint64_t)1), (unsigned int)(((uint64_t)1)>>32));
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1750, (loc1));
        } else {
      dasm_put(Dst, 1756, Dt1(->registers[condition.value.reg]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(condition.value.reg);
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 1761, (loc1), (uint64_t)1);
        } else {
      dasm_put(Dst, 1769, Dt1(->registers[condition.value.reg]), (uint64_t)1);
        }
      }
...
#line 1453 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| jne >1
      dasm_put(Dst, 1782, (condition.value.x64_reg));
...
int aot_cpop(AotContext* context, riscv_register_t target, AotValue a)
{
  ...
  //| and rax, 0x7F
  //| op2_r_x mov, target, rax
  dasm_put(Dst, 1837, (unsigned int)(0x5555555555555555), (unsigned int)((0x5555555555555555)>>32), (unsigned int)(0x3333333333333333), (unsigned int)((0x3333333333333333)>>32), (unsigned int)(0x0F0F0F0F0F0F0F0F), (unsigned int)((0x0F0F0F0F0F0F0F0F)>>32));
  loc1 = riscv_reg_to_x64_reg(target);
  if (VALID_X64_REGISTER(loc1)) {
  dasm_put(Dst, 753, (loc1));
  } else {
...
#line 1702 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      //| shl rax, cl
      //| mov ecx, edx
      dasm_put(Dst, 2095, (bits.value.x64_reg));
...
#line 1802 "src/machine/aot/aot.x64.c"
        ...
        case 0x40:
          ...
          dasm_put(Dst, 2145, Dt1(->pc), ((uint32_t)(value.value.i & 0x7FFFFFFF)), ((value.value.i >> 32) ^ 0x40000000));
...
#line 1810 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 2154, (value.value.x64_reg), Dt1(->pc));
...
int aot_memory_write(AotContext* context, AotValue address, AotValue v, uint32_t size)
{
  ...
  dasm_put(Dst, 2162, size, Dt1(->memory));
...
int aot_memory_read(AotContext* context, uint32_t target, AotValue address, uint32_t size)
{
  ...
  dasm_put(Dst, 2213, size, size, CKB_VM_ASM_RISCV_MAX_MEMORY);
...
static int aot_mov_internal(AotContext* context, riscv_register_t target, AotValue value, x64_register_t x64_temp_reg)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1) && VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 2275, (loc2), (loc1));
      } else if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 2283, (loc1), Dt1(->registers[value.value.reg]));
      } else if (VALID_X64_REGISTER(loc2)) {
      dasm_put(Dst, 2154, (loc2), Dt1(->registers[target]));
      } else {
      dasm_put(Dst, 2291, (x64_temp_reg), Dt1(->registers[value.value.reg]), (x64_temp_reg), Dt1(->registers[target]));
      }
#line 1959 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if ((value.value.i >> (context->version >= 1? 31: 32)) > 0 && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
        loc1 = riscv_reg_to_x64_reg(target);
      dasm_put(Dst, 2306, (x64_temp_reg), (unsigned int)(value.value.i), (unsigned int)((value.value.i)>>32));
        if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 2275, (x64_temp_reg), (loc1));
        } else {
      dasm_put(Dst, 2154, (x64_temp_reg), Dt1(->registers[target]));
        }
      } else {
        loc1 = riscv_reg_to_x64_reg(target);
        if (VALID_X64_REGISTER(loc1)) {
...
#line 1962 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      loc1 = riscv_reg_to_x64_reg(target);
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 2275, (value.value.x64_reg), (loc1));
      } else {
      dasm_put(Dst, 2154, (value.value.x64_reg), Dt1(->registers[target]));
      }
...
static int aot_mov_x64(AotContext* context, x64_register_t x64_target, AotValue value)
{
  ...
  switch (value.tag) {
    case AOT_TAG_REGISTER:
      ...
      if (VALID_X64_REGISTER(loc1)) {
      dasm_put(Dst, 2275, (loc1), (x64_target));
      } else {
      dasm_put(Dst, 2283, (x64_target), Dt1(->registers[value.value.reg]));
      }
#line 1978 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_IMMEDIATE:
      ...
      if ((value.value.i >> (context->version >= 1? 31: 32)) > 0 && ((value.value.i & 0xFFFFFFFF80000000) != 0xFFFFFFFF80000000)) {
      dasm_put(Dst, 2306, (x64_target), (unsigned int)(value.value.i), (unsigned int)((value.value.i)>>32));
      } else {
...
#line 1981 "src/machine/aot/aot.x64.c"
    ...
    case AOT_TAG_X64_REGISTER:
      ...
      dasm_put(Dst, 2275, (value.value.x64_reg), (x64_target));
